...
const HELP_TEXT = {
  ...
  archive: ['Помощь: Архив постов', '', 'Раздел хранит сохранённые посты и снимки, показывает статус архива и лимиты хранения.', 'Обычный сценарий: откройте сохранённые посты, проверьте снимки и при необходимости восстановите пост.', 'Postgres остаётся источником правды. Технический долг по внешнему ключу архива не меняется в этом изменении.', 'Если архива нет, дождитесь появления сохранённых постов или проверьте статус архива.'],
