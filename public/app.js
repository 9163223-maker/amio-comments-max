...
const FAST_SEND_RUNTIME = 'CC8.1.11-FAST-COMMENT-SEND-UNLOCK';
...
function bootOnepass() {
  ...
  if (!guardedSkeleton && (window[FAST_SEND_MARKER] || window[ONEPASS_MARKER])) return;
  ...
  script.src = (guardedSkeleton ? '/public/app-skeleton-consumer-pr67.js?' : '/public/app-fast-send-pr69.js?') + ASSET_VERSION.replace(/^v/, 'v=');
  script.async = false;
  script.dataset.adminkitRuntime = guardedSkeleton ? SKELETON_RUNTIME : FAST_SEND_RUNTIME;
  script.onerror = () => {
