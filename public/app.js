...
const LOADER_MARKER = '__ADMINKIT_CC7_5_51_COMMENT_PHOTO_JSON_UPLOAD__';
const ONEPASS_MARKER = '__ADMINKIT_CC7_5_51_COMMENT_PHOTO_JSON_UPLOAD__';
...
function bootOnepass() {
  ...
  script.src = '/public/app-onepass.js?v=7551';
  script.async = false;
