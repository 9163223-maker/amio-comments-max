...
async function connectedChatsForUser(userId, config={}){return [];}
...
module.exports={listStatsTargetsForUser,listStatsTargetsForUserAsync,_private:{boundToUser,channelPostBoundToUser,accessChannelsForUser,connectedChatsForUser,sharedPickerChannelsForUser}};
