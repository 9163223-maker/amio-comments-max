...
const NON_ADMIN_MESSAGE = 'Опубликовать приглашение может только администратор этого чата или канала.';
const VERIFICATION_FAILURE_MESSAGE = 'Не удалось проверить права администратора. Проверьте, что бот добавлен в чат и имеет нужные права.';
