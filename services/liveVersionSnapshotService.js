...
function safeRuntimeContractSummary() {
  try {
    ...
    return {
      ...
      statsCallbackContractWired: bool(contract.statsCallbackContractWired),
      statsCallbackContractLiveOk: bool(contract.statsCallbackContractLiveOk),
      statsCallbackContractOk: bool(contract.statsCallbackContractOk),
      statsMainMenuRoutesToCurrentStatsRoot: bool(contract.statsMainMenuRoutesToCurrentStatsRoot),
      statsLegacyRootNotReturned: bool(contract.statsLegacyRootNotReturned),
      callbackContractEndpoint: clean(contract.callbackContractEndpoint || '/debug/callback-contract-live'),
...
function summarize(snapshot = {}) {
  ...
  return {
    ...
    statsCallbackContractWired: bool(snapshot.runtimeContract && snapshot.runtimeContract.statsCallbackContractWired),
    statsCallbackContractLiveOk: bool(snapshot.runtimeContract && snapshot.runtimeContract.statsCallbackContractLiveOk),
    statsCallbackContractOk: bool(snapshot.runtimeContract && snapshot.runtimeContract.statsCallbackContractOk),
    statsMainMenuRoutesToCurrentStatsRoot: bool(snapshot.runtimeContract && snapshot.runtimeContract.statsMainMenuRoutesToCurrentStatsRoot),
    statsLegacyRootNotReturned: bool(snapshot.runtimeContract && snapshot.runtimeContract.statsLegacyRootNotReturned),
    callbackContractEndpoint: clean(snapshot.runtimeContract && snapshot.runtimeContract.callbackContractEndpoint || '/debug/callback-contract-live'),
    pr199Ready,
    pr202Ready,
