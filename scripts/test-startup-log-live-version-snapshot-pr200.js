...
assert.strictEqual(final.liveVersionSummary.buttonsSaveRealCallbackOk, true);
assert.strictEqual(final.liveVersionSummary.buttonsSaveIdempotentOk, true);
...
assert.strictEqual(log.latest.liveVersionSummary.buttonsWizardPhysicalRouteProbeOk, true);
assert.strictEqual(log.latest.liveVersionSummary.buttonsSaveRealCallbackOk, true);
assert.strictEqual(log.latest.liveVersionSummary.buttonsSaveIdempotentOk, true);
...
assert.strictEqual(log.latest.finalRuntimeReadinessGate.required.buttonsWizardPhysicalInplaceReady, true);
assert.strictEqual(log.latest.finalRuntimeReadinessGate.required.buttonsSaveRealCallbackOk, true);
assert.strictEqual(log.latest.finalRuntimeReadinessGate.required.buttonsSaveIdempotentOk, true);
