...
(async () => {
  ...
  try {
    ...
    assert(entrypoint.RUNTIME.includes('PR169') || entrypoint.RUNTIME.includes('PR166') || entrypoint.RUNTIME.includes('PR165'), 'active entrypoint exposes PR165+ runtime marker');
