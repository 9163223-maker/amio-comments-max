...
(async () => {
  ...
  try {
    ...
    assert(entrypoint.includes('PR173-PRODUCTION-PUSH-AUDIT') && pkg.sourceMarker === 'adminkit-pr173-production-push-audit', 'active PR173 runtime keeps the PR168 link-chat behavior');
