...
async function main() {
  ...
  assert.strictEqual(entry.finalRuntimeReadinessGate.required.statsCallbackContractLiveOk, true);
  ...
  assert.strictEqual(derivedEntry.finalRuntimeReadinessGate.required.statsCallbackContractLiveOk, true);
