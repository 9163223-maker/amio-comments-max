...
(async () => {
  ...
  assert.deepStrictEqual(probe.variants.plain.requiredClosedWizardMessageIds, probe.variants.plain.closedWizardMessageIds.slice(0, probe.variants.plain.requiredClosedWizardMessageIds.length), 'plain variant closes every previous wizard message id');
