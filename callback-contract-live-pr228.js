...
async function runLiveCallbackContractInProcess() {
  ...
  try {
    ...
    const adminSectionStatsRoutesToCurrentStatsRoot = legacyLabelsPresent.length === 0 && /stats_(home|scope_empty|scope_selector)_pr229|pr226/.test(clean(response.screenId));
