...
const RUNTIME = 'CC7.5.33-CORE-1.48.1-NAVIGATION-V3-HINTS-SAFE';
const SOURCE = 'adminkit-cc7-5-33-core-1-48-1-navigation-v3-hints-safe';
const MARKER = '__ADMINKIT_CC7_5_33_CORE_1_48_1_NAVIGATION_V3_HINTS_SAFE_LOADER__';
...
if (!global[MARKER]) {
  global[MARKER] = true;
  require('./adminkit-one-loader-cc7532');
  process.env.BUILD_VERSION = RUNTIME;
  process.env.RUNTIME_VERSION = RUNTIME;
  process.env.BUILD_SOURCE_MARKER = SOURCE;
  if (!process.env.ADMINKIT_PUBLIC_BASE_URL || /amio-comments-max/i.test(String(process.env.ADMINKIT_PUBLIC_BASE_URL))) {
