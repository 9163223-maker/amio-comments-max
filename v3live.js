...
exports.install=function(){
  ...
  return {ok:true,runtimeVersion:'CC6.7.1',sourceMarker:'adminkit-v3-functional-menu-actions-stress-summary',hardRouter,titleFallback,menuActions,stressTest,stressSummary};
};
