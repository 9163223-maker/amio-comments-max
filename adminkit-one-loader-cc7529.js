...
const RUNTIME = 'CC7.5.29-CORE-1.46.0-POLLS';
const SOURCE = 'adminkit-cc7-5-29-core-1-46-0-polls';
const MARKER = '__ADMINKIT_CC7_5_29_CORE_1_46_0_POLLS_LOADER__';
...
if (!global[MARKER]) {
  global[MARKER] = true;
  require('./adminkit-one-loader-cc7528');
  process.env.BUILD_VERSION = RUNTIME;
  process.env.RUNTIME_VERSION = RUNTIME;
  process.env.BUILD_SOURCE_MARKER = SOURCE;
  if (!process.env.ADMINKIT_PUBLIC_BASE_URL || /amio-comments-max/i.test(String(process.env.ADMINKIT_PUBLIC_BASE_URL))) {
