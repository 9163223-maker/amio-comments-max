'use strict';
require('./cc6529-moderation-compact-ui').install();
...
process.env.BUILD_VERSION='CC6.5.2.9';
process.env.RUNTIME_VERSION='CC6.5.2.9';
process.env.BUILD_SOURCE_MARKER='adminkit-CC6.5.2.9-moderation-compact-ui';
